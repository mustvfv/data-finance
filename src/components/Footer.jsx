...
const Footer = () => {
  return (
    <div className="max-w-[1240px] mx-auto py-16 px-8 grid lg:grid-cols-3 gap-12 text-gray-300">
      <div>
        ...
        <p className="py-4">
          ...
          libero iure obcaecati, voluptate ducimus placeat eos reprehenderit
          quibusdam quisquam, laboriosam facere ipsa dolor consequatur error
          molestiae recusandae aperiam quam.
        </p>
